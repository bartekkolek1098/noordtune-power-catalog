...
writeFileSync(outputIndex>=0?process.argv[outputIndex+1]:existsSync("data/research/v3-2-next20-decisions.json")?"data/research/v3-2-kia-hyundai-acceptance.json":existsSync("data/research/v3-1-reviewed-promotions.json")?"data/research/v3-1-kia-hyundai-acceptance.json":existsSync("data/research/v2-consensus-checkpoint.json")?"data/research/v3-kia-hyundai-acceptance.json":"data/research/v2-kia-hyundai-acceptance.json",JSON.stringify(report,null,2)+"\n");
