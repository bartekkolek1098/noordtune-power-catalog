...
const live=JSON.parse(readFileSync("data/research/v2-rdw-validation.json","utf8"));
...
writeFileSync("data/research/v2-performance.json",JSON.stringify(report,null,2)+"\n");console.log(JSON.stringify(report,null,2));
